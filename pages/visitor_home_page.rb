...
class VisitorHomePage < BasePage
  ...
  def click_search_source_button
    element = get_element(@switch_search_source_button, 'Xpath')
    element.click
  end

  def click_talent_option
    element = get_element(@freelancers_options, 'Xpath')
    element.click
  end

  def click_search_input(keywords)
    element = get_element(@search_talent_input, 'Xpath')
    element.send_keys keywords
  end

  def click_search_button
    element = get_element(@search_button, 'Xpath')
    element.click
  end
end
